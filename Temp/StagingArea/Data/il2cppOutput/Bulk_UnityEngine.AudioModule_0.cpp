...
extern "C"  bool AudioMixer_SetFloat_m3036056706 (AudioMixer_t3521020193 * __this, String_t* ___name0, float ___value1, const RuntimeMethod* method)
{
	typedef bool (*AudioMixer_SetFloat_m3036056706_ftn) (AudioMixer_t3521020193 *, String_t*, float);
	static AudioMixer_SetFloat_m3036056706_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (AudioMixer_SetFloat_m3036056706_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.Audio.AudioMixer::SetFloat(System.String,System.Single)");
...
extern "C"  void AudioMixerSnapshot_TransitionTo_m2523353171 (AudioMixerSnapshot_t1921958751 * __this, float ___timeToReach0, const RuntimeMethod* method)
{
	typedef void (*AudioMixerSnapshot_TransitionTo_m2523353171_ftn) (AudioMixerSnapshot_t1921958751 *, float);
	static AudioMixerSnapshot_TransitionTo_m2523353171_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (AudioMixerSnapshot_TransitionTo_m2523353171_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.Audio.AudioMixerSnapshot::TransitionTo(System.Single)");
